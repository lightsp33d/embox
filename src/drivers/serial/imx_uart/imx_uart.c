...
static void imxuart_configure_pins(void) {
	...
	case 0:
		/* TX */
		iomuxc_set_reg(IOMUXC_SW_MUX_CTL_PAD_SD3_DATA7, 1);
		iomuxc_set_reg(IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT, 2);
		/* RX */
		iomuxc_set_reg(IOMUXC_SW_MUX_CTL_PAD_SD3_DATA6, 1);
		iomuxc_set_reg(IOMUXC_UART1_UART_RX_DATA_SELECT_INPUT, 3);
		break;
	case 1:
		/* Nothing to be done */
		break;
	case 2:
		/* TX */
		iomuxc_set_reg(IOMUXC_SW_MUX_CTL_PAD_EIM_DATA24, 2);
		iomuxc_set_reg(IOMUXC_UART3_UART_RX_DATA_SELECT_INPUT, 0);
		/* RX */
		iomuxc_set_reg(IOMUXC_SW_MUX_CTL_PAD_EIM_DATA25, 2);
		iomuxc_set_reg(IOMUXC_UART3_UART_RX_DATA_SELECT_INPUT, 1);
		break;
	case 3:
		/* TX */
		iomuxc_set_reg(IOMUXC_SW_MUX_CTL_PAD_KEY_COL0, 4);
		iomuxc_set_reg(IOMUXC_UART4_UART_RX_DATA_SELECT_INPUT, 0);
		/* RX */
		iomuxc_set_reg(IOMUXC_SW_MUX_CTL_PAD_KEY_ROW0, 4);
		iomuxc_set_reg(IOMUXC_UART4_UART_RX_DATA_SELECT_INPUT, 1);
		break;
	}
#endif
	return;
